...
# plot graph object
p <- circlepack_fxn(graph, 666)

# save output
figure_dir <- paste0(workdir, "ppi_ml/figures/")
ggsave(paste0(figure_dir, "cplot_annot-status_092523.png"), device = "png", width = 10, height = 10, units = "in")
ggsave(paste0(figure_dir, "cplot_annot-status_092523.pdf"), device = "pdf", width = 10, height = 10, units = "in")
